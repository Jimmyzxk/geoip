...
geodata-mode: true
geox-url:
  geoip: "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/geoip.dat"
```
</details>
...
geodata-mode: true
geox-url:
  mmdb: "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/Country.mmdb"
  asn: "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/GeoLite2-ASN.mmdb"
```
</details>
...
请查看本项目 `release` 分支下的 [srs 目录](https://github.com/Jimmyzxk/geoip/tree/release/srs)。
  ...
  "rule_set": [
    {
      ...
      "type": "remote",
      "format": "binary",
      "url": "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/srs/cn.srs"
    },
    {
      "tag": "geoip-us",
      "type": "remote",
      "format": "binary",
      "url": "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/srs/us.srs"
    }
  ]
}
```
...
请查看本项目 `release` 分支下的 [mrs 目录](https://github.com/Jimmyzxk/geoip/tree/release/mrs)。
...
rule-providers:
  cn-cidr:
    ...
    behavior: ipcidr
    format: mrs
    url: "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/mrs/cn.mrs"
  ...
  google-cidr:
    ...
    behavior: ipcidr
    format: mrs
    url: "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/mrs/google.mrs"
...
请查看本项目 `release` 分支下的 [clash 目录](https://github.com/Jimmyzxk/geoip/tree/release/clash)。
...
rule-providers:
  cn-cidr:
    ...
    behavior: ipcidr
    format: yaml
    url: "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/clash/ipcidr/cn.txt"
  ...
  telegram-cidr:
    ...
    behavior: ipcidr
    format: yaml
    url: "https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/clash/ipcidr/telegram.txt"
...
请查看本项目 `release` 分支下的 [surge 目录](https://github.com/Jimmyzxk/geoip/tree/release/surge)。
...
```conf
[Rule]
RULE-SET,https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/surge/us.txt,REJECT
RULE-SET,https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/surge/cn.txt,DIRECT
RULE-SET,https://cdn.jsdelivr.net/gh/Jimmyzxk/geoip/geoip@release/surge/telegram.txt,PROXY,no-resolve
```
</details>
...
可通过 `go install -v github.com/Jimmyzxk/geoip/geoip@latest` 直接安装 CLI 工具。
...
- [@Loyalsoldier/v2ray-rules-dat](https://github.com/Jimmyzxk/geoip/v2ray-rules-dat)
- [@Loyalsoldier/clash-rules](https://github.com/Jimmyzxk/geoip/clash-rules)
- [@Loyalsoldier/surge-rules](https://github.com/Jimmyzxk/geoip/surge-rules)
...
[![Stargazers over time](https://starchart.cc/Jimmyzxk/geoip/geoip.svg)](https://starchart.cc/Jimmyzxk/geoip/geoip)
